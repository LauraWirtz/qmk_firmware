...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_ortho_5x12(
	...
	_______,			TG(_QWERTY),		KC_LSFT,			_______,			LT(_FKEYS, KC_TAB),	LT(_NUM, KC_SPC),			LT(_SYM, KC_ENT),	KC_SCLN,			KC_LEFT,			KC_DOWN,			KC_UP,				KC_RIGHT
	),
  ...
  [_QWERTY] = LAYOUT_ortho_5x12(
	...
	KC_LCTL,			_______,			_______,			KC_LALT,			KC_SPC,				_______,					_______,			_______,			KC_LEFT,			KC_DOWN,			KC_UP,				KC_RGHT
	),
  [_NUM] = LAYOUT_ortho_5x12(
	...
	_______,			_______,			_______,			_______,			_______,			_______,					LT(_SYM, KC_0),		_______,			KC_HOME,			KC_PGDN,			KC_PGUP,			KC_END
	),
